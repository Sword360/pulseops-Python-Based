...
==============================================================================
Module:       terminal.py
Description:  Non-Blocking Web Terminal Subprocess Engine.
              Executes interactive shell commands and runbooks asynchronously with safe
              sudo elevation, destructive command safeguards, and ANSI stream formatting.
