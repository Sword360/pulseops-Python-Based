...
==============================================================================
Module:       processes.py
Description:  Kernel Process Explorer & Signal Dispatcher.
              Inspects active Linux processes, parses CPU/memory consumption from /proc,
              and provides safe POSIX signal transmission (SIGTERM, SIGKILL, SIGHUP).
