 ...
 * ============================================================================
 * Module:      processes.js
 * Description: Interactive process manager, real-time CPU/memory sorting, search filter, and signal controls.
 *
 * @author      Najmul Islam
        ...
        try {
            ...
            if (data.success) {
                ...
                if (this.tableBody) {
                    ...
                    if (isAuthMismatch) {
                        this.tableBody.innerHTML = `<tr><td colspan="7" style="text-align:center; padding: 2.5rem 1.5rem;">
                            <div style="max-width: 620px; margin: 0 auto; background: var(--bg-card); border: 1px solid rgba(234,179,8,0.5); border-radius: 8px; padding: 1.5rem; text-align: left;">
                                ...
                                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:0.5rem;">
                                    ...
                                    <button class="btn btn-sm btn-secondary" onclick="window.procMgr && window.procMgr.loadProcesses()">🔄 Retry Connection</button>
                                </div>
                            </div>
                        </td></tr>`;
                    } else {
